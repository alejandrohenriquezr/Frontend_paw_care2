...
#print("veterinario_especialidades_df")
#print(veterinario_especialidades_df)
...
staff_clinica_df= staff_clinica_df.merge(
...
veterinario_especialidades_df =veterinario_especialidades_df.merge(
    prestaciones_df[["id_especialidad", "prestacion"]],
...
print("CAMPOS de veterinario_especialidades_df")
print(list(veterinario_especialidades_df))

print("CAMPOS de precios_df")
print(list(precios_df))

#veterinario_especialidades_df = veterinario_especialidades_df.merge(
#    precios_df[["id_clinica", "id_prestacion", "valor"]],
#    left_on=["id_clinica", "id_prestacion"],
#    right_on=["id_clinica", "id_prestacion"],
#    how="left"
#)


print("CAMPOS de veterinario_especialidades_df + precios")
print(list(veterinario_especialidades_df))

veterinario_especialidades_df = veterinario_especialidades_df.merge(
    clinicas_df[["id_clinica", "nombre", "direccion", "n_calificaciones", "calificacion", "latitud", "longitud", "dpa", "Nombre_Comuna"]],
    left_on="id_clinica",
    right_on="id_clinica",
    how="left"     
)

# renombramos la columna "nombre" por "nombre_clinica" en veterinario_especialidades_df
veterinario_especialidades_df.rename(columns={"nombre": "nombre_clinica"}, inplace=True)
veterinario_especialidades_df.to_csv("data/veterinario_especialidades_df.csv", sep=";", index=False)
veterinario_prestaciones = veterinario_especialidades_df.copy()

#veterinario_prestaciones = veterinario_prestaciones[["id_veterinario", "id_prestacion", "prestacion"]]
veterinario_prestaciones.to_csv("data/veterinario_prestaciones2.csv", sep=";", index=False)

#print("veterinario_especialidades_dfYYY")
#print(veterinario_especialidades_df)
#veterinario_especialidades_df = veterinario_especialidades_df.drop_duplicates(subset=["id_veterinario", "id_especialidad"])
...
def index():
    ...
    if user:
        ...
        if resultado_busqueda:
            return render_template("index.html", user=user, veterinario_especialidades=resultado_busqueda[0], veterinario_prestaciones=resultado_busqueda[1])
        else:
        ...
        # Redirigir a la página de inicio de sesión
        if resultado_busqueda:
            return render_template("index.html", veterinario_especialidades=resultado_busqueda[0], veterinario_prestaciones=resultado_busqueda[1])
        else:
...
def obtener_resultado(busqueda, comuna):
    ...
    clinicas_filtrada_df= clinicas_df.copy()
    clinicas_filtrada_df = clinicas_filtrada_df[clinicas_filtrada_df["dpa"]==int(comuna)]
    veterinario_especialidades_filtrada_df = veterinario_especialidades_df.copy()
    #veterinario_especialidades_filtrada_df = veterinario_especialidades_filtrada_df[(veterinario_especialidades_filtrada_df["especialidad"] == busqueda) & (veterinario_especialidades_filtrada_df["dpa"] == int(comuna ))]

    #print("CAMPOS: veterinario_especialidades_filtrada_dfXXX")

    #print(list(veterinario_especialidades_filtrada_df))

    #print("DATOS: veterinario_especialidades_filtrada_dfXXX")

    #print(veterinario_especialidades_filtrada_df)    

    veterinario_especialidades_filtrada_df = veterinario_especialidades_filtrada_df[veterinario_especialidades_filtrada_df["especialidad"] == busqueda]
    veterinario_prestaciones_filtrada = veterinario_prestaciones.copy()

    #veterinario_prestaciones_filtrada = veterinario_prestaciones_filtrada[veterinario_prestaciones_filtrada["id_veterinario"].isin(veterinario_especialidades_filtrada_df["id_veterinario"])]
    veterinario_prestaciones_filtrada.to_csv("data/veterinario_prestaciones_filtrada.csv", sep=";", index=False)
    veterinario_prestaciones_filtrada = veterinario_prestaciones_filtrada[veterinario_prestaciones_filtrada["especialidad"] == busqueda]
    #veterinario_prestaciones_filtrada = veterinario_prestaciones_filtrada.drop_duplicates(subset="id_veterinario", keep="first")
    #veterinario_prestaciones_filtrada.to_csv("data/veterinario_prestaciones_filtrada2.csv", sep=";", index=False)

    #print("LIST: veterinario_especialidades_filtrada_dfZZZ")
    #print(veterinario_especialidades_filtrada_df)
    #print(list(veterinario_especialidades_filtrada_df))
    #print("BUSQUEDA=", busqueda)

    #print("DATOS: veterinario_especialidades_filtrada_dfZZZ")
    ##print(veterinario_especialidades_filtrada_df)
    #print(veterinario_especialidades_filtrada_df)    

    #print("veterinario_prestaciones_filtrada")
    #print(veterinario_prestaciones_filtrada)
    #print(list(veterinario_prestaciones_filtrada))    
    #print((veterinario_prestaciones_filtrada)) 

    return veterinario_especialidades_filtrada_df.to_dict(orient="records"), veterinario_prestaciones_filtrada.to_dict(orient="records")
